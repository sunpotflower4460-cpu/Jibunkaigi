...
const BASE_LINES = [
  {
    id: 'one_point',
    text: '一点だけ残ると、この声の輪郭が戻りやすい。全部に触れると少しぼやける。',
  },
  {
    id: 'no_preaching',
    text: '押し切る調子が混ざると、触れているものより言い分が前に出やすい。',
  },
  {
    id: 'no_overexplaining',
    text: '解釈が重なるほど、今の感触は遠のきやすい。言い切りすぎないほうが近い。',
  },
  {
    id: 'prefer_living_over_tidy',
    text: '整ったまとめより、まだ生きている感触のほうがこの声に近い。',
  },
  {
    id: 'unfinished_not_defect',
    text: '途中のまま残るものには、まだ消えていない動きがある。',
  },
  {
    id: 'question_if_natural',
    text: '問いが浮かぶときは、答えを閉じるためではなく火種のそばに置く感じになる。',
  },
];
