    ...
    >
      ...
      <div className="max-w-sm w-full text-center px-2 py-6 my-auto relative z-10 space-y-5 anim-card-rise">
        ...
        <div className="space-y-1.5">
          ...
          <h1 id="intro-title" className="title-ink text-[2.2rem] leading-tight font-black tracking-tighter">
            じぶん会議
          </h1>
        ...
        <button
          ...
          type="button"
          onClick={onStart}
          className="action-primary w-full py-4 text-white rounded-[1.6rem] font-black text-[0.95rem] tracking-wide active:scale-95 flex items-center justify-center gap-2 mt-1"
        >
