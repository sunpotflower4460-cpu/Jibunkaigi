...
export const minaThoughtNodes = [
  {
    ...
    textSeed: 'いまは整えるより、先に置ける場所が要りそう',
  ...
  },
  {
    ...
    owner: NodeOwners.MINA,
    category: NodeCategories.THOUGHT,
    textSeed: '崩れたままでも、少し息ができる余白が必要そう',
  ...
  },
  {
    ...
    owner: NodeOwners.MINA,
    category: NodeCategories.THOUGHT,
    textSeed: '動けなさを責める前に、急がせないほうがよさそう',
  ...
  },
  {
    ...
    owner: NodeOwners.MINA,
    category: NodeCategories.THOUGHT,
    textSeed: '受け取りたいのに、恥ずかしさが先に身構えていそう',
  ...
  },
  {
    ...
    owner: NodeOwners.MINA,
    category: NodeCategories.THOUGHT,
    textSeed: '抱えすぎて、内側の余白がもう薄くなっていそう',
  ...
  },
  {
    ...
    owner: NodeOwners.MINA,
    category: NodeCategories.THOUGHT,
    textSeed: '言葉になる前のしんどさが、先にたまっていそう',
