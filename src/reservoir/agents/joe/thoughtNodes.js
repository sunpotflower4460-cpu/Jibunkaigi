...
export const joeThoughtNodes = [
  ...
  },
  {
    ...
    owner: NodeOwners.JOE,
    category: NodeCategories.THOUGHT,
    textSeed: 'まだ冷めていない熱が、動くことを許されていない',
  ...
  },
  {
    ...
    owner: NodeOwners.JOE,
    category: NodeCategories.THOUGHT,
    textSeed: '前に進もうとした痕跡が、まだかすかに残っている',
