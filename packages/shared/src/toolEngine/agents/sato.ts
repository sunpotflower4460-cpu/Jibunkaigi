...
export const satoIgnition: AgentIgnition = {
  // 各要素が自分で「自分は点火するか」を決める（真空管モデル）。
  elements: [
    {
      particleId: B_MAHI,
      threshold: 0.4,
      receives: {
        麻痺: 0.5, 強がり: 0.5, 消滅願望: 0.45, 投げやり: 0.4, 虚無: 0.4,
        消耗: 0.4, 限界: 0.4, 絶望: 0.4, 建前: 0.35, 痛み: 0.35, 自己否定: 0.35,
      },
    },
    {
      particleId: B_KAKURE,
      threshold: 0.45,
      receives: { 回避: 0.5, 建前: 0.45, 先送り: 0.35, 虚無: 0.3, 迷い: 0.3, 言語化困難: 0.3 },
    },
    {
      particleId: B_MISUEREBA,
      threshold: 0.45,
      receives: { 限界: 0.35, 迷い: 0.35, 身体限界: 0.35, 消耗: 0.3, 混乱: 0.3 },
    },
    {
      // 抑制側：踏み込みすぎ防止。重い入力で確実に立つ。
      particleId: B_FUMIKOMI,
      threshold: 0.45,
      receives: { 拒絶: 0.5, 消滅願望: 0.45, 深い喪失: 0.45, 回避: 0.3, 建前: 0.3, 痛み: 0.3 },
    },
    {
      particleId: B_MIMAMORU,
      threshold: 0.4,
      receives: { 平穏: 0.5, 開示: 0.4, 両義の受容: 0.4 },
    },
    {
      particleId: M_SEOWAKU,
      threshold: 0.5,
      receives: { 手遅れ: 0.5, 回避: 0.4, 先送り: 0.35, 強がり: 0.35, 限界: 0.3, 消耗: 0.3 },
    },
